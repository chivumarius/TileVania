...
MonoBehaviour:
  ...
  m_LastProjectPath: C:\Users\mariu\UnityProjects\Tile Vania
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 0}
    m_SelectedIDs: 0a970000
    m_LastClickedID: 38666
    m_ExpandedIDs: 0000000000960000
    m_RenameOverlay:
  ...
  m_AssetTreeState:
    ...
    m_CreateAssetUtility:
      ...
      m_ResourceFile: 
  m_ListAreaState:
    m_SelectedInstanceIDs: 22f3ffff
    m_LastClickedInstanceID: -3294
    ...
    m_ScrollPosition: {x: 0, y: 30.714233}
    m_GridSize: 64
...
MonoBehaviour:
  ...
  m_LastVerticalScrollValue: 343.4286
  m_GlobalObjectId: 
  m_InspectorMode: 0
  m_LockTracker:
    m_IsLocked: 0
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      scrollPos: {x: 0, y: 0}
      m_SelectedIDs: 22f3ffff
      m_LastClickedID: -3294
      m_ExpandedIDs: bafaffff12950000
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: 
        m_OriginalName: 
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      index: 1
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-141.0,"y":-112.71429443359375},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -141, y: -112.714294}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":67.5,"y":-72.28570556640625},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 67.5, y: -72.285706}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 2
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Overlays/OverlayMenu
      index: 1
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":24.0,"y":-189.1428680419922},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 24, y: -189.14287}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 2
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 1
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-207.42855834960938,"y":18.857147216796876},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":1,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 1
      snapOffset: {x: -207.42856, y: 18.857147}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 1
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":24.0,"y":25.71428680419922},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 24, y: 25.714287}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 0
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Scene View/Path
      index: 1
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":-327.4295654296875,"y":-204.57244873046876},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: -327.42957, y: -204.57245}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":-240.5714111328125,"y":-156.57144165039063},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":236.0,"y":152.0},"m_SizeOverridden":true}'
      floating: 1
      collapsed: 0
      snapOffset: {x: -240.57141, y: -156.57144}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 236, y: 152}
  ...
  m_Position:
    m_Target: {x: -10.017367, y: 1.5895488, z: -0.03867112}
    speed: 2
    m_Value: {x: -10.088712, y: 1.5324733, z: -0.040831838}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -142.93878
    m_HBaseRangeMax: 142.93878
    m_VBaseRangeMin: -68
    m_VBaseRangeMax: 68
    ...
    m_Translation: {x: 250.14288, y: 119}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 875.5, y: 453.25}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
